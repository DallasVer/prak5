...
public static class DatabaseRequests
{
    ...
    /// Это твой код
    public static void DriversAndTheirCategory()
    {
    ...
    public static void GetCarQuery()
    {
        ...
        while (reader.Read())
        {
            Console.WriteLine($" Id: {reader[0]} \n Название: {reader[2]} \n Id типа машины: {reader[1]} \n Номер машины: {reader[3]} \n Количество пасажиров{reader[4]}");
        }
    ...
    {
        var querySql = $"INSERT INTO car(name) VALUES ('{name}')";
        using var cmd = new NpgsqlCommand(querySql, DatabaseService.GetSqlConnection());
        cmd.ExecuteNonQuery();
    }
    ///Рейс вывод
